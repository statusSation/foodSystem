...
function() {
    return function(e) {
        ...
        t.ENV_ENUM_SUB = i.ENV_ENUM_SUB;
        var a = n(3);
        n(186),
        t.ddSdk = new a.Sdk(r.getENV(), o.log)
    },
    function(e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
    ...
    function(e, t, n) {
        ...
        var r = n(3),
        o = n(3);
        t.ENV_ENUM = o.ENV_ENUM,
        t.APP_TYPE = o.APP_TYPE,
        t.ENV_ENUM_SUB = o.ENV_ENUM_SUB;
        var i, a = n(183); (function(e) {
        ...
        t.getENV = function() {
            ...
            d = /DingTalk/i.test(e),
            u = /dd-web/i.test(e),
            c = "object" == typeof nuva,
            l = "object" == typeof dd && "function" == typeof dd.dtBridge,
            f = l && n || c && n,
            v = d || a.
        default.isDingTalk,
            p = n && v || a.
        default.isWeexiOS || f,
            _ = o && v || a.
        default.isWeexAndroid,
            E = s && v || l,
            N = u,
            P = r.APP_TYPE.WEB;
            if (N) P = r.APP_TYPE.WEBVIEW_IN_MINIAPP;
            else if (E) P = r.APP_TYPE.MINI_APP;
            else if (a.
        default.isWeexiOS || a.
        default.isWeexAndroid) try {
                var M = weex.config.ddWeexEnv;
                P = M === i.miniWidget ? r.APP_TYPE.WEEX_WIDGET: r.APP_TYPE.WEEX
            } catch(e) {
                P = r.APP_TYPE.WEEX
            }
            var h, m = "*",
            k = e.match(/AliApp\(\w+\/([a-zA-Z0-9.-]+)\)/);
            null === k && (k = e.match(/DingTalk\/([a-zA-Z0-9.-]+)/));
            var b;
            k && k[1] && (b = k[1]);
            var g = "";
            if ("undefined" != typeof name && (g = name), g) try {
                var I = JSON.parse(g);
                I.hostVersion && (b = I.hostVersion),
                m = I.language || navigator.language || "*",
                h = I.containerId
            } catch(e) {}
            var y = !!h;
            y && !b && (k = e.match(/DingTalk\(([a-zA-Z0-9\.-]+)\)/)) && k[1] && (b = k[1]);
            var A, S = r.ENV_ENUM_SUB.noSub;
            if (p) A = r.ENV_ENUM.ios;
            else if (_) A = r.ENV_ENUM.android;
            else if (y) {
                var V = e.indexOf("Macintosh; Intel Mac OS") > -1;
                S = V ? r.ENV_ENUM_SUB.mac: r.ENV_ENUM_SUB.win,
                A = r.ENV_ENUM.pc
            } else A = r.ENV_ENUM.notInDingTalk;
            return {
                platform: A,
                platformSub: S,
                version: b,
    ...
    function(e, t, n) {
        ...
        t.compareVersion = o.compareVersion,
        t.ENV_ENUM = o.ENV_ENUM,
        t.ENV_ENUM_SUB = o.ENV_ENUM_SUB;
        var i = function() {
            function e(e, t) {
                ...
                this.setPlatform = function(e) {
                    ...
                    e.platform === n.env.platform && e.bridgeInit().
                    catch(function(e) {
                ...
                this.invokeAPI = function(e, t, i) {
                    ...
                    return ! 1 === n.devConfig.isAuthApi && (i = !1),
                    n.bridgeInitFn().then(function(d) {
                        var u = n.invokeAPIConfigMapByMethod[e],
                        c = n.devConfig.forceEnableDealApiFnMap && n.devConfig.forceEnableDealApiFnMap[e] && !0 === n.devConfig.forceEnableDealApiFnMap[e](t),
                        l = !c && (!0 === n.devConfig.isDisableDeal || n.devConfig.disbaleDealApiWhiteList && -1 !== n.devConfig.disbaleDealApiWhiteList.indexOf(e));
                        if (u || !i) {
                            var f;
                            if (u && (f = u[n.env.platform]), f || !i) {
                                var v = {};
                                v = !l && f && f.paramsDeal && o.isFunction(f.paramsDeal) ? f.paramsDeal(t) : Object.assign({},
                                t);
                                var p = function(e) {
                                    return ! l && f && f.resultDeal && o.isFunction(f.resultDeal) ? f.resultDeal(e) : e
                                };
                                if (o.isFunction(v.onSuccess)) {
                                    var _ = v.onSuccess;
                                ...
                                return d(e, v).then(p,
                                function(t) {
                                    var a = n.hadConfig && void 0 === n.isReady && -1 !== n.configJsApiList.indexOf(e),
                                    s = "object" == typeof t && "string" == typeof t.errorCode && t.errorCode === o.ERROR_CODE.no_permission,
                                    u = "object" == typeof t && "string" == typeof t.errorCode && t.errorCode === o.ERROR_CODE.cancel,
                                    c = r(f, n.env),
                                    l = c && n.env.version && o.compareVersion(n.env.version, c),
                                    _ = (n.env.platform === o.ENV_ENUM.ios || n.env.platform === o.ENV_ENUM.android) && a && s,
                                    E = n.env.platform === o.ENV_ENUM.pc && a && (l && !u && i || s);
                                    return _ || E ? n.config$.then(function() {
                                        return d(e, v).then(p)
                                    }) : Promise.reject(t)
                                }).then(function(r) {
                                    if (n.devConfig.onAfterInvokeAPI) try {
                                    ...
                                    return n.customLog(o.LogLevel.INFO, ['<== "' + e + '" success result: ', r]),
                                    r
                                },
                                function(r) {
                                    if (n.devConfig.onAfterInvokeAPI) try {
                                        ...
                                        n.customLog(o.LogLevel.ERROR, ["call Hook:onAfterInvokeAPI failed, reason:", r])
                                    }
                                    return n.customLog(o.LogLevel.WARNING, ['<== "' + e + '" fail result: ', r]),
                                    Promise.reject(r)
                                })
                            }
                            var E = '"' + e + '" do not support the current platform (' + n.env.platform + ")";
                            return n.customLog(o.LogLevel.ERROR, [E]),
                            Promise.reject({
                                errorCode: o.ERROR_CODE.jsapi_internal_error,
                                errorMessage: E
                            })
                        }
                        var E = "This API method is not configured for the platform (" + n.env.platform + ")";
                        return n.customLog(o.LogLevel.ERROR, [E]),
                        Promise.reject({
                            errorCode: o.ERROR_CODE.jsapi_internal_error,
                            errorMessage: E
                ...
                this.customLog = function(e, t) {
                    ...
                    if (!0 === n.devConfig.debug) n.customLogInstance(r);
                    else {
                        n.logQueue.push(r);
                ...
                this.bridgeInitFn = function() {
                    ...
                    if (t) n.bridgeInitFnPromise = t.bridgeInit().
                    catch(function(e) {
                        ...
                        n.customLog(o.LogLevel.WARNING, [r]),
                ...
                this.exportSdk = {
                    config: function(t) {
                        void 0 === t && (t = {});
                        var r = !0;
                        Object.keys(t).forEach(function(e) { - 1 === ["debug", "usePromise"].indexOf(e) && (r = !1)
                        }),
                        r ? (n.customLog(o.LogLevel.WARNING, ["This is a deprecated feature, recommend use dd.devConfig"]), i(t)) : n.hadConfig ? n.customLog(o.LogLevel.WARNING, ["Config has been executed"]) : (t.jsApiList && (n.configJsApiList = t.jsApiList), n.hadConfig = !0, n.bridgeInitFn().then(function(r) {
                            var o = n.platformConfigMap[e.platform],
                            i = t;
                            o.authParamsDeal && (i = o.authParamsDeal(i)),
                            r(o.authMethod, i).then(function(e) {
                                n.isReady = !0,
                                n.p.resolve(e)
                            }).
                            catch(function(e) {
                    ...
                    devConfig: i,
                    ready: function(e) { ! 1 === n.hadConfig ? (n.customLog(o.LogLevel.WARNING, ["You don 't use a dd.config, so you don't need to wrap dd.ready, recommend remove dd.ready"]), n.bridgeInitFn().then(function() {
                            e()
                    ...
                    checkJsApi: function(t) {
                        ...
                        return t.jsApiList && t.jsApiList.forEach(function(t) {
                            var a = n.invokeAPIConfigMapByMethod[t];
                            if (a) {
                                var s = a[e.platform],
                                d = r(s, e);
                                d && e.version && o.compareVersion(e.version, d) && (i[t] = !0)
                            }
                            i[t] || (i[t] = !1)
                        }),
                        Promise.resolve(i)
        ...
        function() {
            return function(e) {
                ...
                181 : function(e, t, n) {
                    ...
                    E = {},
                    N = null;
                    window.top !== window && (N = window.top, p._resolve()),
                ...
                572 : function(e, t, n) { (function(e, n) {
                        function r(e, t) {
                        ...
                        function i(e, t) {
                            for (var n = -1,
                            r = e.length; ++n < r && !1 !== t(e[n], n, e););
                            return e
                        }
                        function a(e, t) {
                            for (var n = -1,
                            r = t.length,
                            o = e.length; ++n < r;) e[o + n] = t[n];
                            return e
                        }
                        function s(e, t, n, r) {
                            var o = -1,
                        ...
                        function N(e) {
                            var t = this.__data__;
                            return $t ? void 0 !== t[e] : Et.call(t, e)
                        }
                        function P(e, t) {
                            return this.__data__[e] = $t && void 0 === t ? Se: t,
                            this
                        }
                        function M(e) {
                            var t = -1,
                        ...
                        function C(e, t) {
                            var n = this.__data__;
                            return n instanceof M && n.__data__.length == Ae && (n = this.__data__ = new I(n.__data__)),
                            n.set(e, t),
                            this
                        }
                        function T(e, t, n) {
                        ...
                        function x(e, t, n, r, o, a, s) {
                            ...
                            if (u) {
                                ...
                                if (l == Te || l == Ue || f && !a) {
                                    if (c(e)) return a ? e: {};
                                    if (d = ue(f ? {}: e), !t) return te(e, R(d, e))
                                } else {
                                    if (!rt[l]) return a ? e: {};
                                    d = ce(e, l, x, t)
                                }
                            ...
                            var v = s.get(e);
                            if (v) return v;
                            if (s.set(e, d), !u) var p = n ? ne(e) : ye(e);
                            return i(p || e,
                            function(o, i) {
                                p && (i = o, o = e[i]),
                                T(d, i, x(o, t, n, r, i, e, s))
                            }),
                            d
                        }
                        function F(e) {
                        ...
                        function de(e) {
                            var t = e.length,
                            n = e.constructor(t);
                            return t && "string" == typeof e[0] && Et.call(e, "index") && (n.index = e.index, n.input = e.input),
                            n
                        }
                        function ue(e) {
                            return "function" != typeof e.constructor || pe(e) ? {}: F(ie(e))
                        }
                        function ce(e, t, n, r) {
                            var o = e.constructor;
                            switch (t) {
                        ...
                        function le(e) {
                            ...
                            return me(t) && (Lt(e) || Ie(e) || Ne(e)) ? d(t, String) : null
                        }
                        function fe(e, t) {
                        ...
                        function Ne(e) {
                            return Me(e) && Et.call(e, "callee") && (!gt.call(e, "callee") || Nt.call(e) == Ue)
                        }
                        function Pe(e) {
                            return null != e && me(Ft(e)) && !he(e)
                        }
                        function Me(e) {
                            return be(e) && Pe(e)
                        }
                        ...
                        function ge(e) {
                            return !! ke(e) && (he(e) || c(e) ? Pt: tt).test(_e(e))
                        }
                        function Ie(e) {
                            return "string" == typeof e || !Lt(e) && be(e) && Nt.call(e) == xe
                        }
                        function ye(e) {
                            var t = pe(e);
                        ...
                        nt = /^(?:0|[1-9]\d*)$/,
                        rt = {};
                        rt[Ue] = rt["[object Array]"] = rt[Le] = rt[Be] = rt[Oe] = rt[je] = rt[ze] = rt[qe] = rt[Ye] = rt[Je] = rt[Ge] = rt[De] = rt[Ce] = rt[Te] = rt[We] = rt[Re] = rt[xe] = rt[Fe] = rt[He] = rt[Xe] = rt[Ke] = rt[Qe] = !0,
                        rt["[object Error]"] = rt[$e] = rt["[object WeakMap]"] = !1;
                        var ot = {
                            function: !0,
                            object: !0
                        },
                        ...
                        (St && se(new St(new ArrayBuffer(1))) != Be || Vt && se(new Vt) != De || Ut && "[object Promise]" != se(Ut.resolve()) || Ot && se(new Ot) != Re || jt && "[object WeakMap]" != se(new jt)) && (se = function(e) {
                            var t = Nt.call(e),
                ...
                573 : function(e, t, n) {
                    function r(e, t, n) {
                        var r = e[t];
                        h.call(e, t) && d(r, n) && (void 0 !== n || t in e) || (e[t] = n)
                    }
                    function o(e, t, n, o) {
                        n || (n = {});
                        for (var i = -1,
                    ...
                    I = function(e) {
                        ...
                        if (b || s(t) || u(t)) return void o(t, v(t), e);
                        for (var n in t) h.call(t, n) && r(e, n, t[n])
                    });
                    e.exports = I
                },
                574 : function(e, t, n) {
                ...
                575 : function(e, t) {
                    ...
                    function r(e, t) {
                        var r = I(e) || s(e) ? n(e.length, String) : [],
                        o = r.length,
                        a = !!o;
                    ...
                    function i(e, t) {
                        return !! (t = null == t ? _: t) && ("number" == typeof e || M.test(e)) && e > -1 && e % 1 == 0 && e < t
                    }
                    function a(e) {
                        var t = e && e.constructor;
                    ...
                    function s(e) {
                        return u(e) && m.call(e, "callee") && (!b.call(e, "callee") || k.call(e) == E)
                    }
                    function d(e) {
                ...
                576 : function(e, t) {
                    ...
                    function r(e, t) {
                        ...
                        function() {
                            for (var r = arguments,
                            o = -1,
                            i = b(r.length - t, 0), a = Array(i); ++o < i;) a[o] = r[t + o];
                            o = -1;
                    ...
                    function c(e) {
                        ...
                        e = e.replace(E, "");
                        var n = P.test(e);
                        return n || M.test(e) ? h(e.slice(2), n ? 2 : 8) : N.test(e) ? p: +e
                    }
            ...
            return Promise.resolve(function(e, n) {
                return new Promise(function(r, o) {
                    ...
                    function(e) {
                        var t = {};
                        try {
                            if (e && e.__message__) if ("object" == typeof e.__message__) t = e.__message__;
                            else try {
    ...
    function(e, t, n) {
        ...
        var o = n(6);
        t.on = function(e, t) {
            o.requireModule("globalEvent").addEventListener(e,
            function(e) {
                var n = {
    ...
    function(e, t, n) {
        ...
        t.h5AndroidbridgeInit = function() {
            return r || (r = new Promise(function(e, t) {
                ...
                window.nuva && (void 0 === window.nuva.isReady || window.nuva.isReady) ? n() : document.addEventListener("runtimeready",
                function() {
                    n()
                },
                !1)
            ...
            r.then(function() {
                ...
                return new Promise(function(n, r) {
                    if (!0 === t.watch) {
                        var o = t.onSuccess;
                        delete t.onSuccess,
                        "undefined" != typeof WebViewJavascriptBridge && WebViewJavascriptBridge.registerHandler(e,
                        function(e, t) {
    ...
    function(e, t, n) {
        ...
        var o = this && this.__spreadArrays ||
        function() {
            for (var e = 0,
            t = 0,
            n = arguments.length; t < n; t++) e += arguments[t].length;
            for (var r = Array(e), o = 0, t = 0; t < n; t++) for (var i = arguments[t], a = 0, s = i.length; a < s; a++, o++) r[o] = i[a];
            return r
        };
        Object.defineProperty(t, "__esModule", {
            value: !0
        ...
        t.log = function(e) {
            console.log.apply(console, o([r(e.time.getHours()) + ":" + r(e.time.getMinutes()) + ":" + r(e.time.getSeconds())], e.text))
        }
    },
    function(e, t, n) {
        "use strict";
        ...
        t.compareVersion = function(e, t, n) {
            ...
            for (var o, i, a = e.split("-")[0].split(".").map(r), s = t.split("-")[0].split(".").map(r); o === i && s.length > 0;) o = a.shift(),
            i = s.shift();
    ...
    function(e, t, n) {
        ...
        function r(e, t, n) {
            ...
            M = f,
            h = "";
            return h = c ? v || i ? o.PLATFORM.IOS: _ || a ? o.PLATFORM.ANDROID: p ? o.PLATFORM.IPAD: E ? o.PLATFORM.MAC: N ? o.PLATFORM.WINDOWS: P ? o.PLATFORM.BROWSER: o.PLATFORM.UNKNOWN: o.PLATFORM.UNKNOWN,
            {
                isDingTalk: c,
                isWebiOS: v,
                isWebAndroid: _,
    ...
    default().split("."),
        ...
        u = function() {
            ...
            case i.FRAMEWORK.VUE:
                ...
                i.RUNTIME.WEEX === s && (e.appVersion = n.appVersion, e.appName = n.appName);
                break;
            ...
            case i.FRAMEWORK.UNKNOWN:
                i.RUNTIME.WEB === s && (e.platform = i.RUNTIME.WEB),
                i.RUNTIME.UNKNOWN === s && (e.platform = i.RUNTIME.UNKNOWN)
            }
            return e
        } (),
        c = o.
    ...
    function(e, t, n) {
        ...
        t.isFunction = r,
        t.compareVersion = o; (function(e) {
            e.cancel = "-1",
            e.not_exist = "1",
            e.no_permission = "7",
            e.jsapi_internal_error = "22"
        })(t.ERROR_CODE || (t.ERROR_CODE = {})); (function(e) {
            e.pc = "pc",
            e.android = "android",
            e.ios = "ios",
            e.notInDingTalk = "notInDingTalk"
        })(t.ENV_ENUM || (t.ENV_ENUM = {})); (function(e) {
            e.mac = "mac",
            e.win = "win",
            e.noSub = "noSub"
        })(t.ENV_ENUM_SUB || (t.ENV_ENUM_SUB = {})); (function(e) {
            e.WEB = "WEB",
            e.MINI_APP = "MINI_APP",
            e.WEEX = "WEEX",
            e.WEBVIEW_IN_MINIAPP = "WEBVIEW_IN_MINIAPP",
            e.WEEX_WIDGET = "WEEX_WIDGET"
        })(t.APP_TYPE || (t.APP_TYPE = {})); (function(e) {
            e[e.INFO = 1] = "INFO",
    ...
    function(e, t, n) {
        ...
        r.ddSdk.setPlatform({
            ...
            bridgeInit: function() {
                var e = o.getENV();
                return e.appType === i.APP_TYPE.MINI_APP ? Promise.resolve(a.
            default):
                e.appType === i.APP_TYPE.WEBVIEW_IN_MINIAPP ? Promise.resolve(s.
            default):
                e.appType === i.APP_TYPE.WEEX ? u.androidWeexBridge() : d.h5AndroidbridgeInit().then(function() {
                    return d.
                default
                })
            },
    ...
    function(e, t, n) {
        ...
        r.ddSdk.setPlatform({
            ...
            default):
                e.appType === i.APP_TYPE.WEBVIEW_IN_MINIAPP ? Promise.resolve(s.
            default):
                e.appType === i.APP_TYPE.WEEX ? u.iosWeexBridge() : d.h5IosBridgeInit().then(function() {
                    return d.
                default
                })
            },
    ...
    function(e, t, n) { (function(e, t) { (function(e, t) {
                t()
            })(0,
            function() {
                "use strict";
        ...
        t.apiObj = {
            biz: {
                ATMBle: {
                    ...
                    faceManager: o.faceManager$,
                    punchModePicker: i.punchModePicker$
                },
                alipay: {
                    pay: a.pay$
                },
                calendar: {
                    chooseDateTime: s.chooseDateTime$,
                    chooseHalfDay: d.chooseHalfDay$,
                    chooseInterval: u.chooseInterval$,
                    chooseOneDay: c.chooseOneDay$
                },
                chat: {
                    chooseConversationByCorpId: l.chooseConversationByCorpId$,
                    collectSticker: f.collectSticker$,
                    createSceneGroup: v.createSceneGroup$,
                    getRealmCid: p.getRealmCid$,
                    locationChatMessage: _.locationChatMessage$,
                    openSingleChat: E.openSingleChat$,
                    pickConversation: N.pickConversation$,
                    sendEmotion: P.sendEmotion$,
                    toConversation: M.toConversation$
                },
                clipboardData: {
                    setData: h.setData$
                },
                conference: {
                    videoConfCall: m.videoConfCall$
                },
                contact: {
                    choose: k.choose$,
                    chooseMobileContacts: b.chooseMobileContacts$,
                    complexPicker: g.complexPicker$,
                    createGroup: I.createGroup$,
                    departmentsPicker: y.departmentsPicker$,
                    externalComplexPicker: A.externalComplexPicker$,
                    externalEditForm: S.externalEditForm$,
                    setRule: V.setRule$
                },
                cspace: {
                    chooseSpaceDir: U.chooseSpaceDir$,
                    delete: O.delete$,
                    preview: j.preview$,
                    saveFile: $.saveFile$
                },
                ...
                iot: {
                    bind: x.bind$,
                    bindMeetingRoom: F.bindMeetingRoom$,
                    getDeviceProperties: L.getDeviceProperties$,
                    invokeThingService: B.invokeThingService$,
                    queryMeetingRoomList: z.queryMeetingRoomList$,
                    setDeviceProperties: q.setDeviceProperties$,
                    unbind: Y.unbind$
                },
                map: {
                    locate: J.locate$,
                ...
                navigation: {
                    ...
                    setLeft: oe.setLeft$,
                    setMenu: ie.setMenu$,
                    setRight: ae.setRight$,
                    setTitle: se.setTitle$
                },
                realm: {
                    subscribe: de.subscribe$,
                    unsubscribe: ue.unsubscribe$
                },
                shortCut: {
                    addShortCut: ce.addShortCut$
                },
                store: {
                    closeUnpayOrder: le.closeUnpayOrder$,
                    createOrder: fe.createOrder$,
                    getPayUrl: ve.getPayUrl$,
                    inquiry: pe.inquiry$
                },
                telephone: {
                    call: _e.call$,
                    checkBizCall: Ee.checkBizCall$,
                    quickCallList: Ne.quickCallList$,
                    showCallMenu: Pe.showCallMenu$
                },
                user: {
                    checkPassword: Me.checkPassword$,
                    get: he.get$
                },
                util: {
                    chosen: me.chosen$,
                    datepicker: ke.datepicker$,
                    datetimepicker: be.datetimepicker$,
                    decrypt: ge.decrypt$,
                    downloadFile: Ie.downloadFile$,
                    encrypt: ye.encrypt$,
                    isLocalFileExist: Ae.isLocalFileExist$,
                    multiSelect: Se.multiSelect$,
                    open: Ve.open$,
                    openLink: Ue.openLink$,
                    openLocalFile: Oe.openLocalFile$,
                    openModal: je.openModal$,
                    openSlidePanel: $e.openSlidePanel$,
                    presentWindow: we.presentWindow$,
                    previewImage: De.previewImage$,
                    previewVideo: Ce.previewVideo$,
                    scan: Te.scan$,
                    scanCard: We.scanCard$,
                    setScreenBrightnessAndKeepOn: Re.setScreenBrightnessAndKeepOn$,
                    share: xe.share$,
                    startDocSign: Fe.startDocSign$,
                    systemShare: Le.systemShare$,
                    timepicker: Be.timepicker$,
                    uploadAttachment: ze.uploadAttachment$,
                    uploadImage: qe.uploadImage$,
                    uploadImageFromCamera: Ye.uploadImageFromCamera$,
                    ut: Je.ut$
                },
                verify: {
                    openBindIDCard: Ge.openBindIDCard$,
                    startAuth: He.startAuth$
                }
            },
            channel: {
                permission: {
                    requestAuthCode: Xe.requestAuthCode$
                }
            },
            device: {
                accelerometer: {
                    clearShake: Ke.clearShake$,
                    watchShake: Qe.watchShake$
                },
                audio: {
                    download: Ze.download$,
                    onPlayEnd: et.onPlayEnd$,
                    onRecordEnd: tt.onRecordEnd$,
                    pause: nt.pause$,
                    play: rt.play$,
                    resume: ot.resume$,
                    startRecord: it.startRecord$,
                    stop: at.stop$,
                    stopRecord: st.stopRecord$,
                    translateVoice: dt.translateVoice$
                },
                base: {
                    getInterface: ut.getInterface$,
                    getPhoneInfo: ct.getPhoneInfo$,
                    getUUID: lt.getUUID$,
                    getWifiStatus: ft.getWifiStatus$
                },
                connection: {
                    getNetworkType: vt.getNetworkType$
                },
                geolocation: {
                ...
                launcher: {
                    ...
                    launchApp: ht.launchApp$
                },
                nfc: {
                    nfcRead: mt.nfcRead$,
                    nfcStop: kt.nfcStop$,
                    nfcWrite: bt.nfcWrite$
                },
                notification: {
                    actionSheet: gt.actionSheet$,
                    alert: It.alert$,
                    confirm: yt.confirm$,
                    extendModal: At.extendModal$,
                    hidePreloader: St.hidePreloader$,
                    modal: Vt.modal$,
                    prompt: Ut.prompt$,
                    showPreloader: Ot.showPreloader$,
                    toast: jt.toast$,
                    vibrate: $t.vibrate$
                },
                screen: {
                    insetAdjust: wt.insetAdjust$,
                    resetView: Dt.resetView$,
                    rotateView: Ct.rotateView$
                }
            },
            net: {
                bjGovApn: {
                    loginGovNet: Tt.loginGovNet$
                }
            },
            runtime: {
                message: {
                ...
                permission: {
                    requestAuthCode: xt.requestAuthCode$,
                    requestOperateAuthCode: Ft.requestOperateAuthCode$
                }
            },
            ui: {
                input: {
                ...
                nav: {
                    close: Bt.close$,
                    getCurrentId: zt.getCurrentId$,
                    go: qt.go$,
                    preload: Yt.preload$,
                    recycle: Jt.recycle$
                },
                progressBar: {
                    setColors: Gt.setColors$
                },
                pullToRefresh: {
                    disable: Ht.disable$,
                    enable: Xt.enable$,
