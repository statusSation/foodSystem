...
public class FoodApiOrderController {
	...
	private static final Logger logger = LoggerFactory.getLogger(FoodApiOrderController.class);

	@Autowired
	private FoodApiOrderService foodApiService;
	...
	public ResponeBody<JSONObject> createOrder(@RequestParam("storeNo") String storeNo,
		...
		return this.foodApiService.createOrder(storeNo, tableNo, detail);
	}
	...
	public ResponeBody<JSONObject> ordersDetail(@RequestParam("storeNo") String storeNo,
		...
		try {
			...
			return this.foodApiService.getOrderList(storeNo, beginDate, endDate, page, limit);
	...
	public ResponeBody<JSONObject> orderDetailList(@RequestParam("storeNo") String storeNo,
		...
		try {
			...
			return this.foodApiService.getOrderDetailList(storeNo, orderNo);
		} catch (Exception e) {
